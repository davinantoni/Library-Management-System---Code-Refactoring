...
public class Book {
    ...
    private HoldRequestOperations holdRequestOperation = new HoldRequestOperations();
    ...
    public void placeBookOnHold(Borrower bor)
    {
        ...
        holdRequestOperation.addHoldRequest(hr);        //Add this hold request to holdRequests queue of this book
   ...
   // Request for Holding a Book
    ...
    {
        holdRequestOperation.removeHoldRequest();
